...
function Router() {
  return <Switch>
    ...
    <Route path="/admin"><ProtectedPage component={AdminPage} /></Route><Route path="/admin/subscriptions"><ProtectedPage component={AdminSubscriptionsPage} /></Route><Route path="/admin/users"><ProtectedPage component={() => <AdminOperationsPage title="Users" />} /></Route><Route path="/admin/devices"><ProtectedPage component={() => <AdminOperationsPage title="Devices" />} /></Route><Route path="/admin/payments"><ProtectedPage component={() => <AdminOperationsPage title="Payments" />} /></Route><Route path="/admin/licenses"><ProtectedPage component={() => <AdminSubpage title="Licenses" />} /></Route><Route path="/admin/client"><ProtectedPage component={AdminClientPage} /></Route><Route path="/admin/logs"><ProtectedPage component={AdminAuditPage} /></Route><Route path="/admin/settings"><ProtectedPage component={() => <AdminSubpage title="Project settings" />} /></Route><Route path="/support/panel"><ProtectedPage component={SupportPanelPage} /></Route>
    <Route><Home /></Route>
  </Switch>;
}
