...
import { FeaturesPage, ForgotPasswordPage, LegalPage, LoaderHandoffPage, LoginPage, PasswordlessPage, PricingPage, RegisterPage, StatusPage, DownloadPage } from "@/pages/PublicPages";
...
function Router() {
  return <Switch>
    ...
    <Route path="/terms"><LegalPage type="terms" /></Route><Route path="/privacy"><LegalPage type="privacy" /></Route><Route path="/loader-handoff" component={LoaderHandoffPage} />
