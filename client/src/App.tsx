...
function Router() {
  return <Switch>
    <Route path="/" component={Home} /><Route path="/features" component={FeaturesPage} /><Route path="/pricing" component={PricingPage} /><Route path="/download" component={DownloadPage} /><Route path="/status" component={StatusPage} /><Route path="/login" component={LoginPage} /><Route path="/register" component={RegisterPage} /><Route path="/forgot-password" component={ForgotPasswordPage} /><Route path="/passwordless" component={PasswordlessPage} />
    <Route path="/reset-password" component={ResetPasswordPage} /><Route path="/terms"><LegalPage type="terms" /></Route><Route path="/privacy"><LegalPage type="privacy" /></Route>
    ...
    <Route path="/admin"><ProtectedPage component={AdminPage} /></Route><Route path="/admin/subscriptions"><ProtectedPage component={AdminSubscriptionsPage} /></Route><Route path="/admin/users"><ProtectedPage component={() => <AdminOperationsPage title="Users" />} /></Route><Route path="/admin/devices"><ProtectedPage component={() => <AdminOperationsPage title="Devices" />} /></Route><Route path="/admin/payments"><ProtectedPage component={() => <AdminOperationsPage title="Payments" />} /></Route><Route path="/admin/licenses"><ProtectedPage component={() => <AdminOperationsPage title="Payments" />} /></Route><Route path="/admin/client"><ProtectedPage component={AdminClientPage} /></Route><Route path="/admin/logs"><ProtectedPage component={() => <AdminOperationsPage title="Audit logs" />} /></Route><Route path="/admin/settings"><ProtectedPage component={() => <AdminSubpage title="Project settings" />} /></Route>
    <Route><Home /></Route>
  </Switch>;
}
